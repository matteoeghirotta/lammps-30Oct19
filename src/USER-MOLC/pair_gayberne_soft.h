...
PairStyle(gayberne/soft,PairGayBerneSoft)

#else

#ifndef LMP_PAIR_GAYBERNE_SOFT_H
#define LMP_PAIR_GAYBERNE_SOFT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairGayBerneSoft : public Pair {
 public:
  PairGayBerneSoft(LAMMPS *lmp);
  virtual ~PairGayBerneSoft();
 ...
 protected:
  ...
  double **lambda;           // softness
  double nlambda, alphalj;   // softness
  double **lj5;              // softness helper
  ...
  double single_aniso(int, int, int, int,
