...
ComputeStyle(pair/local/numeric,ComputePairLocalNumeric)

#else

#ifndef LMP_COMPUTE_PAIR_LOCAL_NUMERIC_H
#define LMP_COMPUTE_PAIR_LOCAL_NUMERIC_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputePairLocalNumeric : public Compute {
 public:
  ComputePairLocalNumeric(class LAMMPS *, int, char **);
  ~ComputePairLocalNumeric();
  void init();
