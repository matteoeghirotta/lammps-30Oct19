...
PairStyle(coul/long/offcentre/soft,PairCoulLongOffcentreSoft)

#else

#ifndef LMP_PAIR_COUL_LONG_OFFCENTRE_SOFT_H
#define LMP_PAIR_COUL_LONG_OFFCENTRE_SOFT_H

#include "pair.h"

  namespace LAMMPS_NS {

    class PairCoulLongOffcentreSoft : public Pair {
    public:
      PairCoulLongOffcentreSoft(class LAMMPS *);
      virtual ~PairCoulLongOffcentreSoft();
