...
#ifndef COMPUTE_FEP_OFFCENTRE_CHARGES_H
#define COMPUTE_FEP_OFFCENTRE_CHARGES_H

#include "compute.h"

  namespace LAMMPS_NS {

    class ComputeFEPOffcentreCharges : public Compute {
    public:
      ComputeFEPOffcentreCharges(class LAMMPS *, int, char **);
      ~ComputeFEPOffcentreCharges();
      void init();
      void compute_vector();
